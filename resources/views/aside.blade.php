        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('dashboard') }} " class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2">FSSAI</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-header small text-uppercase"><span class="menu-header-text">Fossoc License</span></li>
            <!-- Layouts -->
            <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div data-i18n="Account Settings">Fssai License Expiration</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('licenses.expiring') }}" class="menu-link">
                    <div data-i18n="Account">Expiration List</div>
                  </a>
                </li>
              </ul>
            </li>
