...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card" style="padding:5px">
        <div>
            <a class="btn btn-primary float-end" href={{ route('license_types.create')}} role="button">Add</a>
        </div>
                        ...
                        <td width='10%'>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  ...
                                  <a class="dropdown-item" href={{route('license_types.edit', $type->id)}}><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                  <form method="post" action={{route('license_types.destroy', $type->id)}}>
                                      @method('delete')
                                      @csrf
